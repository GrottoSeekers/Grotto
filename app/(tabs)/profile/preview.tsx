...
const GALLERY_W_ESTIMATE = SCREEN_W - Layout.spacing.md * 2 - 2;
  ...
  return (
    ...
    >
      ...
      <View style={styles.previewBanner}>
        <Ionicons name="eye-outline" size={16} color={GrottoTokens.gold} />
        <Text style={styles.previewBannerText}>
          This is exactly how homeowners see your profile
        </Text>
      </View>
